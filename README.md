...
事業の成長に合わせて社員の採用が組織課題となった。
現在の事業を支え、将来の組織拡大にも耐えられるように組織の拡大が重要となる。

#### 解決策

新卒・中途の面接やカジュアル面談を担当している。
また、面接ノウハウの標準化や共有、構造化面接の導入によって、他のメンバーも面接・面談に参加するよう奨励している。

採用活動をチーム全体の課題とするため、採用定例を週次で開催するようにした。
そこでメンバーの提案を取り入れ、サービスのプレゼンス向上を目的とした技術ブログの定期的な更新をチームの目標とした。
月 2 回のブログ更新を継続している。
自身も技術ブログの運用に関わり、記事も執筆している（[例](https://blog.nnn.dev/entry/2022/01/18/110000)）。
